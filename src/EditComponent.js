...
class EditComponent extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        const newfirstname = this.getFirstname.value; //ดึงค่าจากตัวแปร getFirstname
        const newlastname = this.getLastname.value; //ดึงค่าจากตัวแปร getLastname
        const newbirthday = this.getBirthday.value; 
        const newnationality = this.getNationality.value; 
        const newgender = this.state.getGender;
        const newcountrycode = this.getCountrycode.value;
        const newphone = this.getPhone.value;
        const newcitizen = this.getCitizen.value;
        const newpassport = this.getPassport.value;
    ...
    render() {
        return (
            <div>
                ...
                <div class="row">
                <div className="col-md-1" class="padding2-0-0-15">
                Title : <select required ref={(input)=>this.getTitle = input} defaultValue={this.props.comment.title}>
                                <option>Mr.</option>
                                <option>Mrs.</option>
                                <option>Miss</option>
                            </select>
                    ...
                    Firstname : <input type="text" placeholder="Firstname" size="18" required ref={(input)=>this.getFirstname = input} defaultValue={this.props.comment.firstname} />
                    </div>
                    <div className="col-md">
                    Lastname : <input type="text" placeholder="Lastname" required ref={(input)=>this.getLastname = input} defaultValue={this.props.comment.lastname}/>
                    </div>
                    </div>
                    <div class="row">
                    <div className="col-md-3">
                    Birthday : <input type="date" id="birthday" name="birthday" required ref={(input)=>this.getBirthday = input} defaultValue={this.props.comment.birthday}/>
                    </div>
                    <div className="col-md" class="padding2-0-0-15">
                    Nationality : <select class="nationality" required ref={(input)=>this.getNationality = input} defaultValue={this.props.comment.nationality} >
                    ...
                    <div class="row">
                    <div className="col-md" class="padding2-0-0-15">
                    Citizen ID : <NumberFormat format="#-####-#####-##-#" mask="_" getInputRef = {(input) => this.getCitizen = input} defaultValue={this.props.comment.citizen}/>
                    </div>
                </div>
                <div class="row">
                    <div className="col-md" class="padding2-0-0-15">
                    <div class="form-check form-check-inline">
                     ...
                     Gender : &nbsp;<input class="form-check-input" type="radio" id="male" name="gender" onChange={this.change.bind(this)} value="male"/> male
  </label>
</div>
<div class="form-check form-check-inline">
  <label class="form-check-label">
    <input class="form-check-input" type="radio" id="female" name="gender" onChange={this.change.bind(this)} value="female"/> female
  </label>
</div>
<div class="form-check form-check-inline">
  <label class="form-check-label">
    <input class="form-check-input" type="radio" id="other" name="gender" onChange={this.change.bind(this)}value="Other"/> Other
  </label>
</div>
                    </div>
                </div>
                <div class="row">
                <div className="col-md" class="tel-box" >
                    Mobile Phone :&nbsp;<div Class="select-box" onChange={this.countryFlagHandler} defaultValue={this.props.comment.countrycode}>
                    <img src={this.state.flagImg} alt="" id="img" className="flag-img" />
                    <select id="country" required ref={(input)=>this.getCountrycode = input} id="country" onChange={this.selectCountryHandler} defaultValue={this.state.countryCodeValue}>
                      ...
                      &nbsp;- <input type="text" id="phoneField" name="phoneField" class="phone-field" required ref={(input)=>this.getPhone = input}/>
                    
                </div>
                </div>
                <div class="row">
                    <div className="col-md" class="padding2-0-0-15">
                    Passport No : <input ref={(input)=>this.getPassport = input} defaultValue={this.props.comment.passport}/>
                    </div>
                </div>
                <div class="row">
                    <div className="col-md-8" class="padding2-250-0-15">
                    Expected salary : <input required ref={(input)=>this.getSalary= input} defaultValue={this.props.comment.salary}/> THB
                    </div>
