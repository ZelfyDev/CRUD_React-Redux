...
class CommentForm extends React.Component {
    state = {
		flagImg: 'https://flagpedia.net/data/flags/h80/th.webp',
		countryCodeValue: ''
    };
    ...
    handleSubmit = (e) => {
        ...
        const firstname = this.getFirstname.value; //ดึงค่าจากตัวแปร getFirstname
        const lastname = this.getLastname.value; //ดึงค่าจากตัวแปร getLastname
        const birthday = this.getBirthday.value; 
        const nationality = this.getNationality.value; 
        const gender = this.state.getGender;
        const countrycode = this.getCountrycode.value;
        const phone = this.getPhone.value;
        const citizen = this.getCitizen.value;
        ...
        this.getPhone.value="";
        this.getCitizen.value="";
        this.getPassport.value="";
        this.getSalary.value="";
        console.log(data);
        console.log(this.state.getGender);
    }
    render() {
        return (
            <div class="example">
                ...
                Title : <select required ref={(input)=>this.getTitle = input}>
                                <option>Mr.</option>
                                <option>Mrs.</option>
                                <option>Miss</option>
                            </select>
                    ...
                    Firstname : <input type="text" placeholder="Firstname" size="18" required ref={(input)=>this.getFirstname = input} />
                    </div>
                    <div className="col-md">
                    Lastname : <input type="text" placeholder="Lastname" required ref={(input)=>this.getLastname = input} />
                    </div>
                    </div>
                    <div class="row">
                    <div className="col-md-3">
                    Birthday : <input type="date" id="birthday" name="birthday" required ref={(input)=>this.getBirthday = input}/>
                    </div>
                    <div className="col-md" class="padding2-0-0-15">
                    Nationality : <select class="nationality" required ref={(input)=>this.getNationality = input}>
                    ...
                    <div class="row">
                    <div className="col-md" class="padding2-0-0-15">
                    Citizen ID : <NumberFormat format="#-####-#####-##-#" mask="_" getInputRef = {(input)=>this.getCitizen = input} />
                    </div>
                </div>
                <div class="row">
                    <div className="col-md" class="padding2-0-0-15">
                ...
                <div className="col-md" class="tel-box" >
                    Mobile Phone :&nbsp;<div Class="select-box" onChange={this.countryFlagHandler}>
                    <img src={this.state.flagImg} alt="" id="img" className="flag-img" />
                    <select id="country" required ref={(input)=>this.getCountrycode = input} onChange={this.selectCountryHandler} defaultValue={this.state.countryCodeValue}>
                ...
                <div class="row">
                    <div className="col-md" class="padding2-0-0-15">
                    Passport No : <input ref={(input)=>this.getPassport = input} />
                    </div>
                </div>
                <div class="row">
                    <div className="col-md-8" class="padding2-250-0-15">
                    Expected salary : <input required ref={(input)=>this.getSalary= input} /> THB
                    </div>
